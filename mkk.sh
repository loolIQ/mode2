...
echo -e "\e[38;5;77m      • Welcome to source mode2 - اهلا بك في سورس ديف بروكس •\e[0m"
echo -e "\e[38;5;77m           •{ Setting up offices - جاري رفع المكاتب } •\e[0m"
echo -e "\e[38;5;77m      • Installing source mode2 - جاري تحميل سورس ديف بروكس •\e[0m"
